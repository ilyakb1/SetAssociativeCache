...
{
    [TestClass]
    public class LeastRecentlyUsedReplacementAlgorithmTests
    {
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_Get()
        {
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(3);
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_Add_Get()
        {
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(3);
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_Add_Clear_Get()
        {
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(3);
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_Add2Items_GetSecond()
        {
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(3);
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_Add1_GetNone()
        {
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(3);
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_Add4_FirstShouldBeOverridden()
        {
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(3);
            ...
            ValueData value;
            Assert.IsFalse(algorithm.TryGet(keyData1, out value));
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_Add4_LeastUsedShouldBeOverridden()
        {
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(3);
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_MultiThreading()
        {
            int elementNumber = 100;
            var algorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(elementNumber / 4);
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_MultiThreading_AllFromCache()
        {
            int elementNumber = 100;
        ...
        [TestMethod]
        public void LeastRecentlyUsedReplacementAlgorithm_KeyIsNullObject()
        {
            var replacementAlgorithm = new LeastRecentlyUsedReplacementAlgorithm<KeyData, ValueData>(5);
